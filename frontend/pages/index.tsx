...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-[#18191B]">
      <Sidebar />
      <div className="flex-1 flex flex-col md:ml-[84px]">
        {/* BUILD DNA TOGETHER Section with Profile */}
        <div className="w-full md:pl-16 border-b border-[#232428] shadow-[0_4px_24px_0_rgba(0,0,0,0.12)] relative" style={{background: 'linear-gradient(90deg, #2a2a2a 0%, #233a50 8%, #233a50 20%, #1a1a1a 40%, #181A1B 100%)'}}>
          ...
          <div className="max-w-[1200px] py-8 md:py-20 px-4 md:px-0 md:pl-8">
            <h1 className="text-2xl md:text-3xl lg:text-4xl text-white tracking-wide font-power-grotesk mb-2">
              <span className="font-light">BUILD</span> <span className="font-black" style={{fontWeight: '900'}}>DNA</span>
            </h1>
            <p className="text-[#B0B3B8] text-xs md:text-sm lg:text-base font-inter mb-0">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 md:pl-[84px] bg-[#0d0d0d]">
          <DNASection />
          <div className="h-8" />
          <StepSection />
        </main>
