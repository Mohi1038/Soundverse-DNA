...
const DNASection: React.FC = () => {
  return (
    <section className="font-grotesk bg-[#000000] rounded-2xl border border-[#232428] w-full max-w-[1200px] min-h-[220px] flex flex-col justify-center items-center p-8 mx-auto">
      <h2 className="text-2xl font-semibold mb-2 text-center">Verify your creator identity → Unlock your DNA</h2>
